import{c as u,t as f,b as p}from"./cartStore.rTu5Njuk.js";const c=document.getElementById("checkout-form"),g=document.getElementById("ticket-modal"),a=document.getElementById("ticket-products"),o=document.getElementById("ticket-total"),s=document.getElementById("ticket-customer"),r=document.getElementById("ticket-date"),i=document.getElementById("ticket-id"),l=e=>new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(e).replace("$","$ ");c?.addEventListener("submit",e=>{e.preventDefault();const m=new FormData(c).get("name"),n=u.get(),d=f.get();if(n.length===0){alert("Your cart is empty!");return}a&&(a.innerHTML=n.map(t=>`
