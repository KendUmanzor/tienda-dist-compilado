import{i as m,c as x,r as f,u as g,t as b,d as w,e as c,h as k}from"./cartStore.BTdtbgp3.js";import{t as L}from"./index.Cqpej7dV.js";import"./index.CGNgjO85.js";const o=document.getElementById("cart-overlay"),y=document.getElementById("cart-drawer"),E=document.getElementById("close-cart"),l=document.getElementById("cart-items-list"),d=document.getElementById("empty-cart-state"),u=document.getElementById("cart-footer"),r=document.getElementById("cart-count-badge"),p=document.getElementById("total-price-value"),v=document.getElementById("total-savings-container"),h=document.getElementById("total-savings-value"),B=document.getElementById("clear-cart-btn"),$=document.getElementById("checkout-btn"),I=document.getElementById("go-to-catalog");function i(e){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(e).replace("$","$ ")}m.subscribe(e=>{e?(o?.classList.remove("opacity-0","pointer-events-none"),o?.classList.add("opacity-100"),y?.classList.remove("translate-x-full")):(o?.classList.add("opacity-0","pointer-events-none"),o?.classList.remove("opacity-100"),y?.classList.add("translate-x-full"))});x.subscribe(e=>{!l||!d||!u||!r||(e.length===0?(d.classList.remove("hidden"),l.innerHTML="",u.classList.add("hidden"),r.classList.add("hidden")):(d.classList.add("hidden"),u.classList.remove("hidden"),r.classList.remove("hidden"),r.textContent=String(e.reduce((t,s)=>t+s.quantity,0)),l.innerHTML=e.map(t=>`
                <div class="flex gap-6 group" data-id="${t.id}">
                    ...
                    <div class="flex-1 flex flex-col justify-between py-1">
                        <div class="space-y-1">
                            ...
                            ${t.size?`<p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Talla: ${t.size}</p>`:""}
                        </div>
